...
var Story = require('../models/story'); // Import User Model
  ...
  router.get('/story/:id', function(req, res) {
    ...
    router.post('/createstory', function(req, res) {
       var story = new Story(); // Create new User object
        ...
        story.title = req.body.title; // Save username from request to User object
...
//         router.get('/story/:id', function(req, res) {
//        var showStory = req.params.id;
//        Story.findOne ({ title: req.decoded.title}, function(err, story) {
//        if (err) throw err;
//        else {
//        Story.findOne({ _id: showStory }, function(err, story) {
//            if (err) throw err;
//            else {
//            res.json({ success: true, story: story });    
//            }   
